...
func (this *BitVector) getBits() uint {
    if numBits == 0 {
        return 0
    }
    ...
    this.shiftBits(tmpBuf, 0, /* to */
                   this.baseByte, this.baseBitOffset + this.curBitIndex, /* from */
...
func (this *BitVector) get1Bit() uint {
    ...
    if this.curBitIndex >= this.totNumBits { /* overflow */
        ...
        curFromByte = this.baseBytePtr[totBitOffset/8]
...
func (this *BitVector) get_expGolomb() {
